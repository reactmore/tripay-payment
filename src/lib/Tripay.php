...
class Tripay {
  ...
  /* ########################################## */
  /* Open Payment APi Belum Memiliki End Point  */
  /* ########################################## */
  ...
  public $URL_transDetailOpenMs = 'https://payment.tripay.co.id/api-sandbox/open-payment/{uuid}/detail';
  public $URL_transDetailOpenMp = 'https://payment.tripay.co.id/api/open-payment/{uuid}/detail';
  ...
  public function __construct($privateKey = null, $apiKey = null) {
    if ($privateKey === null AND $apiKey === null) {
      ...
      $this->api_Key = $apiKey;
      $this->dbH = new \mysqli("localhost", "root", "", "db");
    }
  }
